...
@ibm-skills-network/olx-cli/0.1.0-alpha.10 darwin-x64 node-v14.17.0
...
_See code: [src/commands/set-course.js](https://github.com/ibm-skills-network/olx-cli/blob/v0.1.0-alpha.10/src/commands/set-course.js)_
<!-- commandsstop -->
