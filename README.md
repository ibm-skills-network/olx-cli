...
@ibm-skills-network/olx-cli/0.1.4 darwin-x64 node-v16.2.0
...
_See code: [src/commands/set-course.js](https://github.com/ibm-skills-network/olx-cli/blob/v0.1.4/src/commands/set-course.js)_
<!-- commandsstop -->
