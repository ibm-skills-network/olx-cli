...
olx-cli/0.1.0 darwin-x64 node-v14.16.1
...
_See code: [src/commands/set-course.js](https://github.com/ibm-skills-network/olx-cli/blob/v0.1.0/src/commands/set-course.js)_
<!-- commandsstop -->
